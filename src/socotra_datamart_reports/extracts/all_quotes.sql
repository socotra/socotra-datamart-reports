SELECT quote_policy.product_name AS product_name,
    ...
    FROM_UNIXTIME(quote_peril_characteristics.start_timestamp / 1000, '%Y-%m-%d') AS coverage_start,
    FROM_UNIXTIME(quote_peril_characteristics.end_timestamp / 1000, '%Y-%m-%d') AS coverage_end,
