def get_on_risk_query(product_name, as_of_timestamp):
    return f"""
...
def get_transactions_query(product_name, start_timestamp, end_timestamp):
    return f"""
...
def get_policies_query(start_timestamp, end_timestamp):
    return f"""
...
def get_coverage_query(start_timestamp, end_timestamp):
    return f"""
        SELECT policy.locator AS policy_locator,
           exposure.locator AS exposure_locator,
           peril.locator AS peril_locator,
